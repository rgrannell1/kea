...
unit_test("xIntersect")
	...
	it("interof of empty collection is empty (left)") +
	holdsWhen(
	...
	it("interof of empty collection is empty (right)") +
	holdsWhen(
	...
	it("interof of empty collection is empty (both)") +
	holdsWhen(

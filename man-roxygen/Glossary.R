...
#'
#' In order to keep the documentation for what is a very large library terse,
#' certain words are taken to have precise definitions, unless defined otherwise.
#'
...
#'
#' \bold{Variadic}: a function that can accept any infinite number of arguments.
#'

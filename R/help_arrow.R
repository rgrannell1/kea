...
#' Arrow: functional, composable R.
#'
#' Arrow does stuff, stuff you can use!
#'
#' @section Additional Documentation:
#'
#' Arrow is a big, idiosyncratic (but hopefully logical!) library,
#' so it might be a good idea to browse some of the additional help
#' files.
#'
#' \itemize{
